...
public class Geo {
	...
	public static double distancia (Geo loc1, Geo loc2) {
		...
		return 2*raioDaTerraKm*Math.asin(Math.sqrt(Math.pow(Math.sin((lat1Radianos-lat2Radianos)/2), 2) + Math.pow(Math.sin((lon1Radianos-lon2Radianos)/2), 2) * Math.cos(lat1Radianos) * Math.cos(lat2Radianos)));
	}
	...
	public double distancia (Geo loc) {
		...
		return 2*raioDaTerraKm*Math.asin(Math.sqrt(Math.pow(Math.sin((estaLatRadianos-locLatRadianos)/2), 2) + Math.pow(Math.sin((estaLonRadianos-locLonRadianos)/2), 2) * Math.cos(estaLatRadianos) * Math.cos(locLatRadianos)));		
	}
